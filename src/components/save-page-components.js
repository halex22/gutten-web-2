...
export default class SavePageComponent extends BaseComponent {
  ...
  render() {
      ...
      for (const book of this.books) {
        ...
        book.isFavorite = true // this needs to be refactor
        const bookCard = new BookCardComponent(book, this.storageService)
